        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="input-group input-group-sm">
                    ...
                    <div wire:ignore.self class="modal fade" id="modal-export-new-journal-{{ $journal->id }}">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    ...
                    <button class="btn btn-success" type="button" data-bs-toggle="modal" data-bs-target="#modal-export-new-journal-{{ $journal->id }}">
